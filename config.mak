...
EXTRALIBS          = -Wl,-z,noexecstack  -ffast-math   -lncurses -lpng -lz -lmng -lz -ljpeg -lasound -ldl -lpthread -lfreetype -lz -lfontconfig  -lz -lpthread -ldl -rdynamic -L/usr/lib  -lm 
EXTRALIBS_MPLAYER  =  -ldirectfb -lXext -lX11 -lpthread -lXinerama -laa -lcaca -lSDL -lGL -ldl -lesd -laudio -lXt -lpulse
EXTRALIBS_MENCODER = 
