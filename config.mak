...
CFLAGS   = -Wstrict-prototypes -Wmissing-prototypes -Wundef -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Wall -Wno-switch -Wpointer-arith -Wredundant-decls -O4 -march=native -mtune=native -pipe -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -I.  -D_REENTRANT
ASFLAGS  = $(CFLAGS)
...
EXTRALIBS          =  -ffast-math -lpng -lz -lmng -lz -ljpeg -lgif  -ldl -rdynamic  -lm 
EXTRALIBS_MPLAYER  =  -lvbe -llrmi
EXTRALIBS_MENCODER = 
